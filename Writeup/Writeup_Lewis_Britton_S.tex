...
\newpage
	...
	Requirements are presented in a numeric format whith no hierarchical order, it simply creates a reference point for user stories. Hierarchy remains determined by the MoSCoW methodology. It's not exhaustive; there's always room for perpetual development.
