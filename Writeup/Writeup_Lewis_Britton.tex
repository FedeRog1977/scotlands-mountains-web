...
\section{Evaluation}\label{ch7}
	...
	With reference to the GANTT chart in Table 6.5, this portion refers to the continuous isolated element testing completed by [1] the developer (myself) and [2] externals, throughout development. The developer testing has been described. In the case of externals, the discussed small group of development students and professionals (simulated clients) were simply asked to repeat small inputs and processes alike at intervals, just as practiced by myself. The `externals' portion of this was documented in a Q\&A format, as seen in Figure A7.
	...
	The document issued and completed to and by externals and myself relating to comprehensive element testing, with aggregated results, appears under Figure A8. Externals were asked to test features on a full-system run-through. Feedback is delivered and acted upon near the end of the development process. This component is often referred to as `system testing' and involves a large team of testers from the development team and dedicated externals. It's usually purely requirements-based.
...
\newpage
		...
		\subsubsection*{Figure A7: Functionality -- Continuous Testing}
	...
	\begin{longtable}{p{3cm}p{3cm}p{3cm}p{3cm}}
		...
		...\\
		\hline
		\multicolumn{4}{c}{\textsc{Accessibility}}\\
		...\\
		\hline
		\multicolumn{4}{p{13cm}}{Evaluators:}\\
		\hline
		\caption{Functionality -- Continuous Testing}
	\end{longtable}
	\end{center}
...
\newpage
	...
	\begin{longtable}{p{2.5cm}p{3.5cm}p{5cm}p{1.75cm}}
		...
		\texttt{EventListener} (click) (mobile) & N/A & Display page-select drop-down division & As expected\\
		\texttt{href}\newline (link) (mobile) & N/A & Navigate to `Drafting Room' page & As expected\\
		\texttt{href}\newline (link) (mobile) & N/A & Navigate to `Conquest Map' page & As expected\\
		\texttt{href}\newline (button) (mobile) & N/A & Navigate to `Conquest Map' page & As expected\\
		\hline
		...
		\hline
		\texttt{alert} & N/A & Display browser-specific request to use device's location & As expected\\
		\hline
