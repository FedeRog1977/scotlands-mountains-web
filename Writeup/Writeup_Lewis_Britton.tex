...
\section{System Design}\label{ch5}
	...
	All data discussed in Section 4 of this report is included in a basic input-output system [(BIOS, wheyy)] which, through functions and others methods, produces the desired outcomes which satisfy user requirements. A summary of this process can be seen Figure A5. Reference to data can be observed in Figure A4.
...
\newpage
	...
	\end{center}
		...
		\subsubsection*{Figure A5: Functions Summary}
