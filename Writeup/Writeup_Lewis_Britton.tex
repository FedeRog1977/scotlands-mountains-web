...
\newpage
	...
	\begin{longtable}{p{3cm}p{8cm}p{2cm}}
		...
		\hline
		\hline
		\multicolumn{3}{c}{\textsc{Page Select (On `Drafting Room' and `Conquest Map')}}\\
		\hline
		...
		\hline
		\multicolumn{3}{c}{\textsc{Page Select (On `Drafting Room' and `Conquest Map') (Mobile)}}\\
		\hline
