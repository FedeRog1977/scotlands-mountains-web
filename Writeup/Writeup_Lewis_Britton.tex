...
\newpage
	...
	\begin{longtable}{p{2.5cm}p{3.5cm}p{5cm}p{1.75cm}}
		...
		\hline
		\hline
		\multicolumn{4}{c}{\textsc{Header (On `Drafting Room' and `Conquest Map')}}\\
		\hline
		...
		N/A & N/A & Navigation font color changes with transition upon hover & As expected\\
		N/A & N/A & Linear gradient creates a sufficient contrast for dark logo font and lighter navigation font & As expected\\
		\hline
		\multicolumn{4}{c}{\textsc{Body (On `Drafting Room' and `Conquest Map')}}\\
		\hline
		N/A & N/A & \textbf{h1} (and variants), \textbf{h2}, (and variants), \textbf{h3}, \textbf{p}, \textbf{b}, and \textbf{i} fonts are easily readable & As expected\\
		N/A & N/A & \textbf{h1} (and variants), \textbf{h2}, (and variants), \textbf{h3}, \textbf{p}, \textbf{b}, \textbf{i}, and \textbf{small} font sizes are easily readable & As expected\\
		...
		\hline
		N/A & N/A & `Drafting' and `Conquest' on navigation are replaced by the click-promping `hamburger bars'\\
		\hline
