...
\newpage
	...
	The following directory tree in Figure 6.4 maps the comprehensive structure of this system. Lower-tier files under `Audi' font, `aonach\_eagach' GPX, `udlaidh\_bhreac-liath' GPX and Leaflet images are omitted. However, directories are exhausted although they do include floating values (...) from $1$ to $N$ in their respective list. It of course does not include documentation such as this report.
...
\begin{landscape}
		...
		4.1 & Continuous Element Testing & HTML, JavaScript, Cmd Line & & & & \cellcolor{gray} & \cellcolor{gray} & \cellcolor{gray} & \cellcolor{gray} & \cellcolor{gray} & \cellcolor{gray}\\
		4.2 & Isolated Element Testing & HTML, JavaScript, Cmd Line & & & & & & & & & \cellcolor{gray}\\
		4.3 & Isolated Comprehensive Testing & HTML, JavaScript, Cmd Line & & & & & & & & & \cellcolor{gray}\\
		4.4 & Distribute System for Testing & E-Mail Server/Client, People & & & & & & & & & \cellcolor{gray}\\
		4.5 & Review Feedback \& Implement Changes & Various & & & & & & & & & \cellcolor{gray} & \cellcolor{gray}\\
                \hline
		\textbf{5} & \textbf{Write-Up} &\\
		5.1 & Structure Report & Various & & & & & & & & & & \cellcolor{gray}\\
		5.2 & Write Body of Report & Various & & & & & & & & & & \cellcolor{gray} & \cellcolor{gray} & \cellcolor{gray} & \cellcolor{gray}\\
		5.3 & Write \& Amend Appendices and Figures & Various & & & & & & & & \cellcolor{gray} & \cellcolor{gray} & \cellcolor{gray} & \cellcolor{gray} & \cellcolor{gray} & \cellcolor{gray}\\
                \hline
        \end{tabular}
                \caption{GANTT Chart}
        \end{center}
...
\newpage
		...
		\begin{table}[h]
			...
			\renewcommand{\arraystretch}{1.25}
		\begin{center}
		\begin{tabular}{rr|p{2.3cm}p{2.3cm}p{2.3cm}p{3cm}}
			\textsc{\#} & \textsc{Brand} & \textsc{Beef \%} & \textsc{Description} & \textsc{Photograph}\\
			\hline
			1 & House of Bruar & 78\% & ... & \vspace{-0.25cm}\includegraphics[width=2.5cm]{../System/Photos/bruar_lorne.jpg}\\
			2 & Simon Howie (Steak) & \textasciitilde40\% & ... & \vspace{-0.25cm}\includegraphics[width=2.5cm]{../System/Photos/sh_lorne.png}\\
			3 & Marks \& Spencer & \textasciitilde40\% & ... & \vspace{-0.25cm}\includegraphics[width=2.5cm]{../System/Photos/ms_lorne.jpeg}\\
			4 & Simon Howie (Beef) & \textasciitilde35\% & ... & \vspace{-0.25cm}\includegraphics[width=2.5cm]{../System/Photos/sh_lorne2.png}\\
			5 & Malcolm Allan & \textasciitilde30\% & ... & \vspace{-0.25cm}\includegraphics[width=2.5cm]{../System/Photos/ma_lorne.jpg}\\
			\hline
		\end{tabular}
