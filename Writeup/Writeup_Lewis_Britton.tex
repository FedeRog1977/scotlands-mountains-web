...
\end{landscape}
	...
	Furthermore, FontAwesome (FontAwesome, 2021) was used in simplifying the user experience by implementing recognizable and relatable symbols in places where text would create too much [bloat] and unecessary reading. This also aids accessibility and imporves navigation. Common uses of these are detailed in Table 5.2 below.
...
\newpage
	...
	\begin{longtable}{p{2.5cm}p{2.5cm}p{2.5cm}p{2.5cm}p{2.5cm}}
		...
		\hline
		\hline
		\multicolumn{5}{c}{\textsc{Score Route}}\\
		\hline
		...\\
		\hline
		\multicolumn{5}{c}{\textsc{Describe Route Score}}\\
		\hline
		...\\
		\hline
		\multicolumn{5}{c}{\textsc{Search Route}}\\
		\hline
		...\\
		\hline
		\multicolumn{5}{c}{\textsc{Search Landmass}}\\
		\hline
		...\\
		\hline
		\hline
		...
		\hline
		\hline
		\multicolumn{5}{c}{\textsc{Search `Ability'}}\\
		\hline
		...\\
		\hline
		\multicolumn{5}{c}{\textsc{Search `Equipment'}}\\
		\hline
		...\\
		\hline
		\hline
		...
		\hline
		\hline
		\multicolumn{5}{c}{\textsc{Change Map Layer}}\\
		\hline
		...\\
		\hline
		\multicolumn{5}{c}{\textsc{Show Current Location \& Find Nearest}}\\
		\hline
		...\\
		\hline
		\multicolumn{5}{c}{\textsc{Show \& Hide Features}}\\
		\hline
		...\\
		\hline
		\multicolumn{5}{c}{\textsc{Filter Routes by `Ability'}}\\
		\hline
		...\\
		\hline
		\multicolumn{5}{c}{\textsc{Filter Routes by `Equipment'}}\\
		\hline
		...\\
		\hline
		\multicolumn{5}{c}{\textsc{Score Route}}\\
