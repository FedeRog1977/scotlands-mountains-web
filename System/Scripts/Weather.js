fetch('https://raw.githubusercontent.com/FedeRog1977/Burning/master/System/JSON/Hills.json?token=GHSAT0AAAAAABTAJOXCFWUKPU2S5U4RBYU4YSYD6PA')
    .then((resp) => {
        return resp.json();
    })
    .then((data) => {
        ...
        test.innerHTML = hills.landmass[0].name;
    })
