fetch('https://raw.githubusercontent.com/FedeRog1977/Burning/master/JSON/Hills.json?token=GHSAT0AAAAAABTAJOXDZ4VBYKYG6WV5IO3SYSX7RRA')
    .then((resp) => {
        return resp.json();
    })
    .then((data) => {
        ...
        test.innerHTML = hills.corbett[0].name;
    })
